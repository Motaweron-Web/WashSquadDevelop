...
@section('content')
    ...
    <section class="editService">
        <form action="{{route('addminsubservice')}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mb-3">
            ...
            <div class="row">
                @foreach($carsizes as $carsize)
                    <div class="col-md-5 p-2">
                        <div class="mb-3">
                            ...
                            <input class="form-control" name="prices[]" value="" type="text" placeholder="">
                        </div>
                    </div>
                @endforeach
                    <div class="col-md-5 p-2">
                        ...
                        @foreach($subservices as $service )
                            <div class="form-check mb-2">
                                <input class="form-check-input" name="subservices[]" type="checkbox" value="{{$service->id}}" id="{{$service->id}}">
                ...
                <div class="col-md-5 p-2">
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="timer" type="time" placeholder="">
                    </div>
                </div>
            </div>
