...
<div class="main-content">
    <div class="page-content">
        ...
        <section class="editService">
            <form action="{{route('updatesubservice',$service->id)}}" enctype="multipart/form-data" method="post">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 p-2">
                        ...
                        <div class="form-check mb-2">
                            <input class="form-check-input" name="subsubservices[]" type="checkbox" @foreach($servicesubservice as $ser)  @if($ser->sub_sub_service_id==$service->id)  checked @endif @endforeach value="{{$service->id}}" id="{{$service->id}}">
