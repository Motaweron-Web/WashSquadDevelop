                    ...
                    <div class="row">
                        <div class="col-md-6 p-2">
                            <div class="mb-4">
                                ...
                                <input class="form-control" type="text" name="full_name" value="{{$Apps->full_name}}">
                            </div>
                            <div class="mb-4">
                                <label class="form-label"> تاريخ الانضمام </label>
                                <input class="form-control" type="date" name="created_at" value="{{date('Y-m-d',strtotime($Apps->created_at))}}">
                            </div>
                            <div class="mb-4">
                        ...
                        <div class="col-md-12 p-2">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" value="CASH" @if($Apps->payment_method!=null) {{in_array('CASH',json_decode($Apps->Payment_method))?'checked':''}}  @endif id="pay1" name="Payment_method[]">
                                <label class="form-check-label" for="pay1">
                                    CASH
                                </label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" value="POS"   @if($Apps->payment_method!=null)  {{in_array('POS',json_decode($Apps->Payment_method))?'checked':''}}@endif id="pay2" name="Payment_method[]">
                                <label class="form-check-label" for="pay2">
                                    POS
                                </label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" value="ONLINE" @if($Apps->payment_method!=null)  {{in_array('ONLINE',json_decode($Apps->Payment_method))?'checked':''}}@endif id="pay3" name="Payment_method[]">
                        ...
                        <div class="col-md-12 p-2">
                            ...
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" value="polishing_washing"  @if($Apps->main_packages!=null)  {{in_array('polishing_washing',json_decode($Apps->main_packages))?'checked':''}}@endif  id="package1" name="main_packages[]">
                                <label class="form-check-label" for="package1">
                                    تلميع داخلي مع غسيل بخار خارجي
                                </label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" value="steam_wash" @if($Apps->main_packages!=null)  {{in_array('steam_wash',json_decode($Apps->main_packages))?'checked':''}}@endif id="package2" name="main_packages[]">
                                <label class="form-check-label" for="package2">
                                    غسيل بالبخار داخلي و خارجي
                                </label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" value="sterilization" @if($Apps->main_packages!=null)   {{in_array('sterilization',json_decode($Apps->main_packages))?'checked':''}}@endif id="package3" name="main_packages[]">
                                <label class="form-check-label" for="package3">
                                    تعقيم داخلي مع غسيل بخار خارجي
                                </label>
                            </div>
                            <div class="form-check mb-2">
                                <input class="form-check-input" type="checkbox" value="sent_Services" @if($Apps->main_packages!=null)  {{in_array('sent_Services',json_decode($Apps->main_packages))?'checked':''}}@endif id="package4" name="main_packages[]">
                    ...
                    <div class="d-flex align-content-center justify-content-between py-2">
                        <div class="d-flex align-items-center ">
                            ...
                            <div class="form-check form-switch ms-3">
                                <input class="form-check-input" id="wash" type="checkbox"  value="1" role="switch" checked name="is_active">
