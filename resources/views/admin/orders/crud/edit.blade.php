...
<div class="mod-content " id="mod-content-form">
    <form action="{{route('orders.update',$order->id)}}" id="Form" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row pt-4">
            <div class="col-md-6">
                <div class="mb-3 " >
                    ...
                    <input class="form-control " name="full_name" value="{{$order->user->full_name??''}}" type="text" id="default-input"
                           placeholder="">
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input class="form-control numbersOnly" name="phone" value="{{$order->user->phone??''}}" type="text" id="default-input"
                           placeholder="">
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input class="form-control" name="order_date" value="{{$order->date}}" type="date" id="default-input"
                           placeholder="">
                </div>
            </div>
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input class="form-control" name="order_time" value="{{$order->order_time}}" type="time" id="default-input"
                           placeholder="">
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <div class="number">
                        ...
                        <input class="count numbersOnly" name="number_of_cars" value="{{$order->number_of_cars??0}}" id="number_of_cars" type="text" />
            ...
            <div class="col-md-6">
                <div class="mb-3">
                    ...
                    <input class="form-control numbersOnly" id="price_total" value="{{$order->price_total}}" readonly name="price_total" type="text"
                           placeholder="">
                </div>
            </div>
            {{--            <div class="col-md-6">--}}
...
<script>
    ...
    get_all_price({{$order->service_id}},{{$order->size_id}},{{$order->number_of_cars}})
</script>
