                    ...
                    <div class="row">
                        <div class="col-md-6 p-2">
                            ...
                            <div class="mb-4">
                                ...
                                <input class="form-control" type="number" id="" value="{{$AppSettingDriver -> phone}}" name="phone">
                            </div>
                        ...
                        <div class="col-md-6 p-2">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="password" id="" value= "{{$AppSettingDriver -> password}}" name="password">
                            </div>
                            <div class="mb-3">
                                <label class="form-label"> اسم العامل </label>
                                <input class="form-control" type="number" id="" value="{{$AppSettingDriver -> worker_name}}" name="worker_name">
                            </div>
