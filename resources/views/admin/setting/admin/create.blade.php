    ...
    <section class="editService">
        <form action="{{route('admin.add.admin')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="d-flex align-items-center mb-4 ">
                ...
                <div class="d-flex align-items-center ms-3 flex-wrap">
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" name="permissions[]" type="checkbox" value="{{\App\Models\Permission::find(1)->id}}" id="main1">
            ...
            <div class="d-flex align-items-center mb-4 ">
                ...
                <div class="d-flex align-items-center ms-3 flex-wrap">
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(2)->id}}" id="main1">
                        <label class="form-check-label" for="main1">
            ...
            <div class="d-flex align-items-center mb-4 ">
                ...
                <div class="d-flex align-items-center ms-3 flex-wrap">
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(3)->id}}" id="order1">
                        <label class="form-check-label" for="order1">
                            {{\App\Models\Permission::find(3)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(4)->id}}" id="order2">
                        <label class="form-check-label" for="order2">
                            {{\App\Models\Permission::find(4)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(5)->id}}" id="order3">
                        <label class="form-check-label" for="order3">
                            {{\App\Models\Permission::find(5)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(6)->id}}" id="order4">
            ...
            <div class="d-flex align-items-center mb-4 ">
                ...
                <div class="d-flex align-items-center ms-3 flex-wrap">
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" name="permissions[]" type="checkbox" value="{{\App\Models\Permission::find(7)->id}}" id="app1">
            ...
            <div class="d-flex align-items-center mb-4 ">
                ...
                <div class="d-flex align-items-center ms-3 flex-wrap">
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" name="permissions[]" type="checkbox" value="{{\App\Models\Permission::find(8)->id}}" id="operation1">
            ...
            <div class="d-flex align-items-center mb-4 ">
                ...
                <div class="d-flex align-items-center ms-3 flex-wrap">
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" name="permissions[]" type="checkbox" value="{{\App\Models\Permission::find(9)->id}}" id="driver1">
            ...
            <div class="d-flex align-items-center mb-4 ">
                ...
                <div class="d-flex align-items-center ms-3 flex-wrap">
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(10)->id}}" id="reprot1">
                        <label class="form-check-label" for="reprot1">
                            {{\App\Models\Permission::find(10)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(11)->id}}" id="reprot2">
                        <label class="form-check-label" for="reprot2">
                            {{\App\Models\Permission::find(11)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(12)->id}}" id="reprot3">
            ...
            <div class="d-flex align-items-center mb-4 ">
                ...
                <div class="d-flex align-items-center ms-3 flex-wrap">
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(13)->id}}" id="money1">
                        <label class="form-check-label" for="money1">
                            {{\App\Models\Permission::find(13)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(14)->id}}" id="money2">
                        <label class="form-check-label" for="money2">
                            {{\App\Models\Permission::find(14)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(15)->id}}" id="money3">
            ...
            <div class="d-flex align-items-center mb-4 ">
                ...
                <div class="d-flex align-items-center ms-3 flex-wrap">
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" name="permissions[]" type="checkbox" value="{{\App\Models\Permission::find(16)->id}}" id="client1">
            ...
            <div class="d-flex align-items-center mb-4 ">
                ...
                <div class="d-flex align-items-center ms-3 flex-wrap">
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(17)->id}}" id="setting1">
                        <label class="form-check-label" for="setting1">
                            {{\App\Models\Permission::find(17)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(18)->id}}" id="setting2">
                        <label class="form-check-label" for="setting2">
                            {{\App\Models\Permission::find(18)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(19)->id}}" id="setting3">
                        <label class="form-check-label" for="setting3">
                            {{\App\Models\Permission::find(19)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(20)->id}}" id="setting4">
                        <label class="form-check-label" for="setting4">
                            {{\App\Models\Permission::find(20)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(21)->id}}" id="setting5">
                        <label class="form-check-label" for="setting5">
                            {{\App\Models\Permission::find(21)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(22)->id}}" id="setting6">
                        <label class="form-check-label" for="setting6">
                            {{\App\Models\Permission::find(22)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(23)->id}}" id="setting7">
                        <label class="form-check-label" for="setting7">
                            {{\App\Models\Permission::find(23)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(24)->id}}" id="setting8">
                        <label class="form-check-label" for="setting8">
                            {{\App\Models\Permission::find(24)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(25)->id}}" id="setting9">
                        <label class="form-check-label" for="setting9">
                            {{\App\Models\Permission::find(25)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(26)->id}}" id="setting10">
                        <label class="form-check-label" for="setting10">
                            ط{{\App\Models\Permission::find(26)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(27)->id}}" id="setting11">
                        <label class="form-check-label" for="setting11">
                            {{\App\Models\Permission::find(27)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(28)->id}}" id="setting12">
                        <label class="form-check-label" for="setting12">
                            {{\App\Models\Permission::find(28)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(29)->id}}" id="setting13">
                        <label class="form-check-label" for="setting13">
                            {{\App\Models\Permission::find(29)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(30)->id}}" id="setting14">
                        <label class="form-check-label" for="setting14">
                            {{\App\Models\Permission::find(30)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(31)->id}}" id="setting15">
                        <label class="form-check-label" for="setting15">
                            {{\App\Models\Permission::find(31)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(32)->id}}" id="setting16">
            ...
            <div class="d-flex align-items-center mb-4 ">
                ...
                <div class="d-flex align-items-center ms-3 flex-wrap">
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(33)->id}}" id="shop1">
                        <label class="form-check-label" for="shop1">
                            {{\App\Models\Permission::find(33)->name}}
                        </label>
                    </div>
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" type="checkbox" name="permissions[]" value="{{\App\Models\Permission::find(34)->id}}" id="shop2">
            ...
            <div class="d-flex align-items-center mb-4 ">
                ...
                <div class="d-flex align-items-center ms-3 flex-wrap">
                    <div class="form-check mx-3 my-2">
                        <input class="form-check-input" name="permissions[]" type="checkbox" value="{{\App\Models\Permission::find(35)->id}}" id="mess1">
            ...
            <div class="d-flex align-content-center justify-content-end py-2">
                <button type="submit" class="btn orangeBtn px-5"> انشاء </button>
            </div>
        </form>
    </section>
    <!-- end edit Service -->
