...
class AdminSubServiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.subservices.index')->with(['services'=>$services]);
    }
    ...
    public function create()
    {
        ...
        return view('admin.subservices.create')->with(['parents'=>$service_all]);
    ...
    public function store(Request $request)
    {
        $this->validate($request,[
            ...
            'en_note' => 'nullable|string',
            'ar_note' => 'nullable|string',
        ...
        $service->en_note=$request->en_note!=null?$request->en_note:'';
        $service->ar_note=$request->ar_note!=null?$request->ar_note:'';
    ...
    public function edit($id)
    {
        ...
        $service_all=Service::where('level',1)->where('id','!=',$service->parent_id)->get();
        $service_spacial=Service::where('id',$service->parent_id)->first();

        return view('admin.subservices.edit')->with(['service'=>$service,'parent_service'=>$service_spacial,'parents'=>$service_all]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $service->en_des=$request->en_des;
        $service->ar_des=$request->ar_des;
        $service->en_note=$request->en_note!=null?$request->en_note:$service->en_note;
        $service->ar_note=$request->ar_note!=null?$request->ar_note:$service->ar_note;
        /* $service->price=$request->price;*/
        $service->price=0;
        $service->parent_id=$request->parent_id;
