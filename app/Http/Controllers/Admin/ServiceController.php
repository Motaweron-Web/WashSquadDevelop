...
class ServiceController extends Controller
{
    ...
    public  function  getsubserviceformainservice($id){
         ...
         $subservices=Service::with('subsubservices')->where('parent_id',$id)->where('level',2)->get();
       $service=Service::find($id);
    ...
    public  function getminsubservice()
    {
         ...
         $minsubservices=Service::with('subservices')->where('level',3)->get();
    ...
    public  function  updatesubservice($id,Request $request){
        ...
        return redirect()->route('getsubserviceformainservice',$service->parent_id);
    }
 ...
 public  function updateminsubservice($id,Request $request){
     ...
     return redirect()->route('getminsubservice');
